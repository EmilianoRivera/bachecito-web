    ...
    <div class="container-preloader">
      ...
      <svg viewBox="0 0 178 40" width="178" height="40">
        ...
        <g id="car">
          ...
          >
            <defs>
              ...
              <g id="wheel">
                <use href="#circle" fill="#1E1E1E" transform="scale(10)"></use>
                ...
                ></path>
                <use href="#circle" fill="#1E1E1E" transform="scale(1.5)"></use>
            ...
            <g transform="translate(51.5 11.125)">
              ...
              ></path>
              <rect fill="#1E1E1E" x="3.25" y="-3" width="5" height="3"></rect>
            </g>
        ...
        >
          ...
          ></path>
          <path class="air" stroke="#D1D1D1" d="M 65 12 q -5 3 -12 3.8"></path>
          <path
            class="air"
            stroke="#D1D1D1"
          ...
          ></path>
          <path class="air" stroke="#D1D1D1" d="M 31 33 h -10"></path>
          <path class="air" stroke="#D1D1D1" d="M 29.5 23 h -12"></path>
          <path class="air" stroke="#D1D1D1" d="M 13.5 23 h -6"></path>
          <path class="air" stroke="#FF4D35" d="M 28 28 h -27.5"></path>
        </g>
      </svg>
    </div>
  );
