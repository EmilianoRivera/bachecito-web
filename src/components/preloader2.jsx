    ...
    return (
        <div className="loader">
            <svg className="car" width="102" height="40" xmlns="http://www.w3.org/2000/svg">
                <g transform="translate(2 1)" stroke="#FF9F49" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <path className="car__line car__line--middle" d="M20.5 23.5H0.4755" strokeWidth="3" />
                    <path className="car__line car__line--bottom" d="M25.5 9.5H6.5" strokeWidth="3" />
                </g>
            </svg>
        </div>
    );
