  ...
  return (
    <div className="container-inicio">
        ...
        <div className="animacion1">
          <div className="contenedor-sec2-inicio" id="cont">
            ...
            <div className="image-container">
              ...
              <div className="circle1 top-left"></div>
              <div className="circle2 middle-right"></div>
              <div className="circle3 bottom-right"></div>
              <div className="hover-message">🚧</div>
            </div>
          </div>
      ...
      <div className='Seccion3'>
        <div className="long-text-container" id="longTextContainer">
          <div className="horizontal-scroll">
            ...
            <div className="section section2">
              <div className='align-section2'>
                ...
                <div className="text-section2">
                  ...
                  <p>Es fácil y rápido. Solo necesitas proporcionar<br />
                     algunos detalles básicos y ¡listo! Tu cuenta te 
                     <br />permitirá acceder a todas las funcionalidades de <br />
            ...
            <div className="section section3">
              <div className='align-section2'>
                <div className="text-section2-right">
                  <h2>2.  INICIA SESIÓN  🛵</h2>
                  <p>Una vez que hayas creado tu cuenta, inicia sesión <br />
                     con tus datos. Con tu cuenta, podrás dar seguimiento <br />
                     a tus reportes realizados y acceder a funcionalidades<br />
                      geniales en nuestra aplicación web 😎</p>
                </div>
                <div className="image-section2">
            ...
            <div className="section section4">
              <div className='align-section2'>
                ...
                <div className="text-section2">
                  <h2>3.  ¡REPORTA! 🚩</h2>
                  <p>¡Es hora de marcar la diferencia! Simplemente  <br />
                    selecciona la opción para reportar un bache, llena el <br />
                    formulario y envíanos tu reporte ✌</p>
                </div>
              </div>
            </div>
            <div className="section section5">
              <div className='bubles-align-section5'>
                ...
                <img className="bubble b1" src="https://i.postimg.cc/Cx2PpH4w/bache1.jpg" alt="Burbuja" />
                <img className="bubble b1" src="https://i.postimg.cc/05GBKS9C/bache10.jpg" alt="Burbuja" />
                <img className="bubble b2" src="https://i.postimg.cc/nzBwkjBp/bache12.jpg" alt="Burbuja" />
                <img className="bubble b2" src="https://i.postimg.cc/XJfQFM6v/bache5.jpg" alt="Burbuja" />
                <img className="bubble b2" src="https://i.postimg.cc/8zcKYnMy/bache9.jpg" alt="Burbuja" />
                <img className="bubble b1" src="https://i.postimg.cc/PxsSPXcc/bache2.jpg" alt="Burbuja" />
                <img className="bubble b2" src="https://i.postimg.cc/QMW68961/bache3.jpg" alt="Burbuja" />
                <img className="bubble b1" src="https://i.postimg.cc/QCDYn8J5/bache11.jpg" alt="Burbuja" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className='Seccion4'>
        <div className="content-inicio-sec4">
          <div className="text-sec4-inicio">
            ...
            <a href="/Cuenta"><button className="fill-button">¡Crear cuenta! </button></a>

          </div>
          <div className="image-sec4-inicio">
      ...
      <div className='Seccion5'>
        ...
        <div className="image-container-sec5">
          <div className="card">
        ...
        <button className="download-button">Descarga la Aplicación</button>
      </div>
